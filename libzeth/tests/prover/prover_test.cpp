    ...
    const prover<snarkT> &prover, const typename snarkT::KeypairT &keypair)
{
    ...
    bits254 rho_bits254 = bits254_from_hex(
        "12226c9424e97769433333d59f5f3af148572c5402e953ec6b2d21f5efa2476b");
    ...
    bits254 h_sig = bits254_from_hex(
        "13826c9424e9d7853471a21d59f5faf148572c5402e953ec6b2d21f5efa24e6b");
    bits254 phi = bits254_from_hex(
        "13826c9424e9d785471a21d59f5faf143572c53402e953ec6b2d21f5efa24e6b");
    ...
    zeth_note note_input(
        a_pk_bits254, value_bits64, rho_bits254, trap_r_bits254);
    zeth_note note_dummy_input(
        a_pk_bits254,
        bits64_from_hex("0000000000000000"),
        bits254_from_hex(
            "13826c9424e9d785471a21d59f5f3af483572c5402e953ec6b2d21f5efa24e6b"),
        trap_r_bits254);
    ...
    bits254 a_pk_out_bits254 = bits254_from_hex(
        "1388157cc25efd1d8e057f32fa7c750275614659a0fa1dec6b2d21f5efa24e6b");
    bits254 rho_out_bits254;
    bits254 trap_r_out_bits254 = bits254_from_hex(
